 ...
 *
 * SparkContext object also implements and overrides the setMETrigger and getMETrigger functions of trait METrigger to trigger dynamic model evaluation
 */
object SparkContext extends Logging with METrigger{
  ...
  /** Overriding the set and get METrigger functions of trait METrigger
    *
    * setMETrigger will be used in Client.scala to set the trigger state to true when RMRequestState is true.
    */
